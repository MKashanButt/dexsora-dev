...
<body class="font-sans antialiased bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute top-0 left-0 w-96 h-96 bg-blue-200/20 rounded-full -translate-x-48 -translate-y-48 animate-float-slow"></div>
            <div class="absolute bottom-0 right-0 w-96 h-96 bg-purple-200/20 rounded-full translate-x-48 translate-y-48 animate-float-medium"></div>
            <div class="absolute top-1/2 left-1/2 w-64 h-64 bg-indigo-200/10 rounded-full -translate-x-32 -translate-y-32 animate-float-fast"></div>
        ...
        <div class="max-w-md w-full space-y-8 relative z-10">
            <div>
                <div class="mx-auto h-20 w-20 flex items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 shadow-2xl">
                ...
                <p class="mt-3 text-center text-lg text-gray-600">
                    Create your account and streamline your work management
                </p>
            </div>
            
            <form class="mt-10 space-y-8" action="{{ route('register.post') }}" method="POST">
                @csrf
                <div class="space-y-6">
                    <div>
                ...
                <div>
                    <button type="submit" class="group relative w-full flex justify-center py-4 px-6 border border-transparent text-lg font-semibold rounded-2xl text-white bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 hover:from-blue-700 hover:via-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        <span class="absolute left-0 inset-y-0 flex items-center pl-6">
                            <svg class="h-6 w-6 text-blue-300 group-hover:text-blue-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
